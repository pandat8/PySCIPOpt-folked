...
cdef extern from "scip/scip.h":
    ...
    ctypedef enum SCIP_HEURTIMING:
        ...
        SCIP_HEURTIMING_AFTERNODE         = (SCIP_HEURTIMING_AFTERLPNODE | SCIP_HEURTIMING_AFTERPSEUDONODE)
        SCIP_HEURTIMING_AFTERPLUNGE       = (SCIP_HEURTIMING_AFTERLPPLUNGE | SCIP_HEURTIMING_AFTERPSEUDOPLUNGE)
